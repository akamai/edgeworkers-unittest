...
describe('Modify an HTML streamed response by replacing text string', () => {
    ...
    it("should remove content-encoding & content-length headers and modify HTTP response by performing a find & replace operation", () => {
        ...
        mockGetVariable.onCall(0).returns("xyz").returns("abc");
        mock_HttpResponse_getHeaders.returns({"content-encoding":"zip", "content-length":"200", "header3":"value3"});
        httpRequest.returns(new Promise(function(resolve) {resolve(mockHttpResponse)}));
        createResponse.returns({"status":200, "headers":{"header3": "value3"}, "body":"modified HTTP response abc"});
