import {onClientRequest} from "../../../edgeworkers/examples/respond-from-edgeworkers/respondwith/microservice-geolocation/main";
...
describe('Respond with JSON formatted geographical location information', () => {
    ...
    it("return geographical location information", () => {
        ...
        expect(requestMock.respondWith.calledWith(200, {}, JSON.stringify({ geoInfo: {"latitude":"42.364948","longitude":"-71.088783","continent":"NA","country":"US","zipCode":"N/A","region":"MA","city":"BOSTON","dma":"506","timezone":"EST","networkType":"mobile","bandwidth":"257","areaCodes":["617"],"fips":["25025","25017"],"source": "Akamai EdgeWorkers"}}))).to.be(true);
    });
});
