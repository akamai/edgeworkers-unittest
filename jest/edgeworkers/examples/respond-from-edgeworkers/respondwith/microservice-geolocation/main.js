...
export function onClientRequest (request) {
  ...
  info.latitude = (request.userLocation.latitude) ? request.userLocation.latitude : 'N/A';
  info.longitude = (request.userLocation.longitude) ? request.userLocation.longitude : 'N/A';
  ...
  info.zipCode = (request.userLocation.zipCode) ? request.userLocation.zipCode : 'N/A';
